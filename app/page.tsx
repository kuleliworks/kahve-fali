...
export default function Page() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-12">
      ...
      {/* İçindekiler (mini) */}
      <nav className="mx-auto mt-14 max-w-4xl">
      ...
      <div className="mx-auto mt-10 max-w-4xl">
        <article className="prose-article">
          ...
          <p>
            <a href="/hakkimizda">Hakkımızda</a> sayfasında yaklaşımımızı, <a href="/blog">blog</a> bölümünde ise rehber içeriklerimizi bulabilirsin.
            Soruların için <a href="/iletisim">iletişim</a> sayfasına göz at.
          </p>
          ...
          <ul>
            ...
            <li>En az bir kapak (kapat) fotoğrafı eklemeye çalış.</li>
            <li>En fazla 3 fotoğraf; en iyi sonuç genelde 2–3 net kareyle gelir.</li>
          </ul>

          <h2 id="sss">Sık sorulan sorular</h2>
          <div className="not-prose divide-y divide-stone-200 overflow-hidden rounded-2xl ring-1 ring-stone-200">
            ...
            <details className="group p-5">
              ...
              <div className="mt-3 text-stone-700">
                Form aşamasında çerez kullanılmaz. Gizliliğe önem veriyoruz.
              </div>
            </details>
